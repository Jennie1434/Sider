...
const choices = [
  {
    id: 'albert',
    title: 'PROCESS & REPORTING (Albert)',
    description: 'Connecter les feedbacks clients directement dans un Google Sheet structuré.',
    icon: FileSpreadsheet,
    score: { albert: 1, eugenia: 0 }
  },
  {
    id: 'eugenia',
    title: 'MACHINE À IDÉES (Eugenia)',
    description: 'Un script qui génère chaque matin 5 opportunités business via GPT-4.',
    icon: Sparkles,
    score: { albert: 0, eugenia: 1 }
  },
  {
    id: 'neutral',
    title: 'ONBOARDING (Neutre)',
    description: 'Envoyer l\'email de bienvenue automatiquement.',
    icon: Mail,
    score: { albert: 0, eugenia: 0 }
  }
];

export default function PhaseNoCode({ onComplete }) {
  ...
  return (
    ...
    >
      <h2 className="text-3xl font-bold text-white mb-3">
        ÉTAPE 4 : NO-CODE (LE WORKFLOW)
      </h2>
      <p className="text-slate-400 mb-8 text-lg">
        Votre équipe est débordée. Que souhaitez-vous automatiser en premier ?
      </p>
